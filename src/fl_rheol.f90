...
Z600 = 1
do j=1,nz
tempar = 0.25*(temp(j,nx/2)+temp(j+1,nx/2)+temp(j,nx/2+1)+temp(j+1,nx/2+1))
!do j=1,nz
...
!         end do
!        write(*,*) 'sarc1(5)',sarc1(5),'sarc1(20)',sarc1(20),'sarc(40)',sarc2(40)
endif
irh_mark = 0
...
!!            if(abs(sarc11).gt.0.) write(*,*) i,j,sarc11,sarc22
        ...
        if (irh.eq.6 .or. irh.ge.11) then
            ...
            if (ny_inject.gt.0.and.i.le.iinj.and.i.ge.iinj) aps (j,i) = 0.
        end if
